...
public class Lab8 {
	public static void main(String[] args) {
		...
		boolean validString = false; //TODO if it breaks this line is why
		...
		do {
			...
			while (!validInt) {
				try {
					...
					stuID = input - 1;
					System.out.println("Student " + input + " is " + studentTable[stuID][0] + " "
							+ studentTable[stuID][1] + ". What would you like to know about " + studentTable[stuID][0]
			...
			while (!validString) {
				...
				try {
					if (infoRequest.equalsIgnoreCase("hometown")) {
						System.out.println(studentTable[stuID][0] + " is from " + studentTable[stuID][2]
								+ ". Would you like to know more? (enter \"yes\" or \"no\")");
						validString = true;
					} else if (infoRequest.equalsIgnoreCase("favorite food")) {
						System.out.println(studentTable[stuID][0] + " likes to eat " + studentTable[stuID][3]
								+ ". Would you like to know more? (enter \"yes\" or \"no\")");
						validString = true;
					} else {
